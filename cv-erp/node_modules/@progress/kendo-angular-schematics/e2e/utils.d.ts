...
export declare function checkStringInFile(filePath: string, searchString: string): boolean;
export declare function printSpecificKeys(filePath: string, specificKey: string): void;
